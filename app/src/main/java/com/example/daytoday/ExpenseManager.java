...
public class ExpenseManager extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(ExpenseManager.this,"sussuccesful",Toast.LENGTH_SHORT).show();
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(ExpenseManager.this,"data insert successfully",Toast.LENGTH_SHORT).show();

            startActivity(new Intent(getApplicationContext(), ExpenseManager2.class));
